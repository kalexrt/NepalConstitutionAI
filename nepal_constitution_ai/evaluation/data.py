eval_data = {
    'question': [
        'What are the prohibitions on imposition of restrictions on political parties?',
        'Who is responsible for determining the distribution of revenue between the Federal, State, and Local levels in Nepal?',
        'Who holds the executive power in Nepal according to the Constitution?',
        'What are the official symbols of Nepal, including its national flag, anthem, and other national emblems?',
        "How is the composition of Nepal's House of Representatives determined?",
        "What is the role of the Constitutional Bench in Nepal's Supreme Court?",
        'What are the qualifications required to be appointed as the Chief Commissioner or a Commissioner of the Commission for the Investigation of Abuse of Authority in Nepal?',
        'What are the circumstances under which a seat in the State Assembly can become vacant in Nepal?',
        'What are the citizenship requirements for holding key positions in Nepal according to the Constitution?',
        'What transitional provisions are included in the Constitution of Nepal regarding the judiciary?'
    ],
    'answer': [],
    'contexts': [],
    'ground_truth': [
        ...
        This distribution is guided by recommendations from the National Natural Resources and Fiscal Commission, based on the need for expenditure and revenue capacity. 
        Additionally, a Federal Act governs the distribution, considering factors such as national policies, autonomy, and financial powers of the State and Local levels.''',
        ...
        Political parties must ensure representation from various groups, including women, Dalit, indigenous peoples, Khas Arya, Madhesi, Tharu, Muslims, and people from backward regions, 
        with a special focus on geography, territorial balance, and inclusion of persons with disabilities.
        ...
        For other constitutional positions, individuals can qualify if they have citizenship by descent, naturalized citizenship, or citizenship by birth. 
        However, naturalized citizens must have resided in Nepal for at least ten years, while those with citizenship by birth or naturalized citizenship under specific provisions must have resided in Nepal for at least five years.''',
        
        '''The Constitution of Nepal outlines several transitional provisions for the judiciary:
        The existing Supreme Court, Constituent Assembly Court, Appellate Courts, and District Courts will continue until the new judicial structure is established under this Constitution. 
        Cases already filed will be settled by these courts.
